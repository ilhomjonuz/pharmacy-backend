...
from .views import (PopularPillsAPIView, LastPillsAPIView, DiscountPillsAPIView, RatingPillsAPIView, AllPillsAPIView,
                    ...
                    OrderCreateApiView, EntryCreateAPIView, CommentaryCreateAPIView, SocialLinksListAPIView)
...
urlpatterns = [
    ...
    path('create/comment/', CommentaryCreateAPIView.as_view(), name='create-comment'),
    ...
    path('social_links/', SocialLinksListAPIView.as_view(), name='social-links')
]
